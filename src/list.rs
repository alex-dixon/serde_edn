...
//impl List {
//    #[inline]
//    pub fn from_str(s: &str) -> Option<List> {
//        Some(List { value: String::from(s) })
//    }
//}
//
//impl Serialize for List {
...
//
//            #[inline]
//            fn visit_str<E>(self, value: &str) -> Result<List, E>
//                where
//                    E: de::Error,
//            {
//                List::from_str(value).ok_or_else(|| de::Error::custom("not a list"))
//            }
//
//            #[inline]
//            #[cfg(any(feature = "std", feature = "alloc"))]
//            fn visit_string<E>(self, value: String) -> Result<List, E>
//                where
//                    E: de::Error,
//            {
...
////                Some(b' ') |  Some(b'\n') |  Some(b'\r') | Some(b'\t') => Ok(()),
////                Some(_)=> {
////                    Ok(self.parse_list(&mut self.scratch))
////                }
////
////                None => {}
////            }
